...
![Hardware Block Diagram](https://raw.githubusercontent.com/DavinciDaMaster/DaVinci/main/_entries/Tachometer_Media/TachoHighLevel.png)  
...
The calculation of the RPM from the CrankShaftPosition sensor output (CKP: One square pulse ever rotation of the Output Crankshaft) and the driving of the display through SPI signals sent to the Shift Registers, was done using a CH32V003F4U6 on a custom breakout board.  
